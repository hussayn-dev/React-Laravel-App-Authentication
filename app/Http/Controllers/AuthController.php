...
class AuthController extends Controller
{
 ...
 public function register(Request $request) {
    ...
    $validation = Validator::make($request->all(),[
        ...
        'first_name' => 'bail|required|alpha_dash|min:3|max:20',
        'last_name' => 'bail|required|alpha_dash|min:3|max:20',
...
public function login (Request $request)
{
    ...
    return $this->jsonResponseService->success("Login successful",['token' => $token, 'expires_at' => Carbon::parse($expiration)->toDateTimeString()], 200);
    } catch (CustomException $e) {
